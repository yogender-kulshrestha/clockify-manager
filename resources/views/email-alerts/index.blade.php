...
@section('title', 'All Email Alerts')
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Email Alerts</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">All Email Alerts</h6>
    </nav>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">All Email Alerts</h5>
