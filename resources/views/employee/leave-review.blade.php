                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" name="date_from" value="{{$data->date_from}}" id="date_from" placeholder="Select Date From">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" name="date_to" value="{{$data->date_to}}" id="date_to" placeholder="Select Date To">
    ...
    <script>
        $(document).ready(function (){
            ...
            /*$("#add_button").on('click', function () {
                $('#status').val('Revise and Resubmit');
            });

            $("#add2_button").on('click', function () {
                $('#status').val('Approved');
            });*/
