                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select disabled class="form-control" name="leave_type_id" id="leave_type_id" placeholder="Select Leave Type">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" name="date_from" value="{{\Carbon\Carbon::parse($data->date_from)->format('d-m-Y')}}" id="date_from" placeholder="Select Date From">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" class="form-control" name="date_to" value="{{\Carbon\Carbon::parse($data->date_to)->format('d-m-Y')}}" id="date_to" placeholder="Select Date To">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <textarea disabled class="form-control" name="title" id="title">{{$data->title}}</textarea>
                                        <span id="title_error" class="text-danger"></span>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    @if($data->attachment)
                                        <div class="form-group">
                                            <a download href="{{asset($data->attachment)}}" class="btn btn-dark btn-sm" for="attachment">View Attachment</a>
                                        </div>
                                    @endif
                                </div>
                                <div class="col-md-3">
        ...
        $(document).ready(function (){
            /*$(document).ready(function(){
                $("#date_from").on('changeDate', function (selected) {
                    ...
                    $('#date_to').attr('setStartDate', minDate);
                });

                $("#date_to").on('changeDate', function (selected) {
                    var maxDate = new Date(selected.date.valueOf());
                    $('#date_from').attr('setEndDate', maxDate);
                });
            });*/
