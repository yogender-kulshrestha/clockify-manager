    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if(auth()->user()->role == 'user')
                <li class="nav-item">
                    <a href="{{route('time-sheets.index')}}"
                       class="nav-link {{Route::is('time-sheets.*') ? 'active' : ''}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Time Sheets</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('time-cards.index')}}"
                       class="nav-link {{Route::is('time-cards.*') ? 'active' : ''}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Time Cards</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            @endif
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#users" class="nav-link {{Route::is('employees.*') || Route::is('employees-*') ? 'active' : ''}}"
                       aria-controls="users" role="button" aria-expanded="{{Route::is('employees.*') || Route::is('employees-*') ? 'ture' : 'false'}}">
                    ...
                    <div class="collapse {{Route::is('employees.*') || Route::is('employees-*') ? 'show' : ''}}" id="users">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item {{Route::is('employees-time-sheets.*') ? 'active' : ''}}">
                                <a class="nav-link {{Route::is('employees-time-sheets.*') ? 'active' : ''}}" href="{{route('employees-time-sheets.index')}}">
                                    <span class="sidenav-mini-icon"> TS </span>
                                    <span class="sidenav-normal"> Time Sheets</span>
                                </a>
                            </li>
                            <li class="nav-item {{Route::is('employees-time-cards.*') ? 'active' : ''}}">
                                <a class="nav-link {{Route::is('employees-time-cards.*') ? 'active' : ''}}" href="{{route('employees-time-cards.index')}}">
            ...
            @if(auth()->user()->role == 'admin')
                ...
                {{--<li class="nav-item">
                    <a href="{{route('employees-time-sheets.index')}}"
                       class="nav-link {{Route::is('employees-time-sheets.*') ? 'active' : ''}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a href="{{route('employees-time-cards.index')}}"
                       class="nav-link {{Route::is('employees-time-cards.*') ? 'active' : ''}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a href="{{route('employees-records.index')}}" class="nav-link {{Route::is('employees-records.*') ? 'active' : ''}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a href="{{route('employees-leaves.index')}}" class="nav-link {{Route::is('employees-leaves.*') ? 'active' : ''}}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
