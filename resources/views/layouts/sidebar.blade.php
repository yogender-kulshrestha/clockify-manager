    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0"
           href=" https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/default.html " target="_blank">
            <img src="{{asset('assets/img/logo-ct-dark.png')}}" class="navbar-brand-img" alt="clockify">
            <span class="ms-1 font-weight-bold">{{config('app.name', 'Clockify')}}</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="{{route('hr-managers.index')}}"
                   class="nav-link {{Route::is('hr-managers.*') ? 'active' : ''}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            ...
            <li class="nav-item">
                <a href="{{route('approvers.index')}}"
                   class="nav-link {{Route::is('approvers.*') ? 'active' : ''}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                    ...
                    <span class="nav-link-text ms-1">Approvers</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('records')}}"
                   class="nav-link {{Route::is('records') ? 'active' : ''}}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 46 42" version="1.1"
                             xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
